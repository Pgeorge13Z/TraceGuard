...
timeeach_BP(u-1)=sum_lbp/sim_Count;
timeeach_VE(u-1)=sum_ve/sim_Count;
timeeach_Pearl(u-1)=sum_pearl/sim_Count;
timeeach_JT(u-1)=sum_jt/sim_Count;
...
legend('u=2','u=3','u=4','u=5');
xlabel('number of evidence node =1');
