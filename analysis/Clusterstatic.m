function [time_each] = Clusterstatic(time_each,Ntot,Nclustersmax)
...
%%  Inference with Junction Tree:
    ...
    time_each(Nclusters)=sum_jt/sim_Count;
end
fprintf('Avg. Inference time with JT,Nclusters=%1.0f, max_edges= %1.0f is %1.4f\n',Nclusters,max_edges,time_each(Nclusters));
